...
3. **TypeScript First**: NEVER use `any`. Always define interfaces or types. Use explicit typing.
4. **Absolute Imports**: Always use `@/` alias for imports mapping to `src/`.
5. **Code Generation**: Provide complete, copy-paste ready code. Do not use placeholder comments for critical logic.
