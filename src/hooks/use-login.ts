...
import { isGuestOnlyRoute, ROUTE_CONFIG } from '@/config/routes.config';
import apiClient from '@/lib/axios';
import { setCredentials } from '@/store/slices/auth-slice';
import { setUserProfile, type UserProfile } from '@/store/slices/user-slice';
...
/**
 * TanStack Query v4 mutation that:
